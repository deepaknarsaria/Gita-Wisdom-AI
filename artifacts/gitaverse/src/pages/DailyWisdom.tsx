...
import { Flower2, BookOpen, RefreshCw } from "lucide-react";
...
export default function DailyWisdom() {
  ...
  return (
    <PageLayout>
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-4 sm:px-6 py-16 md:py-20">
